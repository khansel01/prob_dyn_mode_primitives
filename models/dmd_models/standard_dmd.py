""" An implementation of standard dynamic mode decomposition.

Reference:
Schmid, P. J. (2010). Dynamic mode decomposition of numerical and experimental data.
Journal of fluid mechanics, 656, 5-28.

Tu, J. H., Rowley, C. W., Luchtenburg, D. M., Brunton, S. L., & Kutz, J. N. (2013). On dynamic mode decomposition:
Theory and applications. arXiv preprint arXiv:1312.0041.
...
class StandardDMD(BaseDMD):
    ...
    def fit(self, x0: jnp.ndarray, x1: jnp.ndarray, **kwargs) -> None:
        """ Compute the Standard Dynamic Mode Decomposition given the two snapshot matrices x0 and x1
        ...
        self.mu, self.phi = self._eig(self.a_tilde, u_r)
