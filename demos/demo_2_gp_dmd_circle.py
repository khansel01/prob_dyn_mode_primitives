...
parser.add_argument("--l_r", default=1e-2, type=float,
                    help="Specifies the learning rate of the Optimizer.")


def demo():
    """
    This demo shows an example of GP-DMD on the circle shape data set.
    :return: None
    """
    ...
    _samples = gp_dmd.get_sample(labels_x, labels_idx, t_steps, 1000)
