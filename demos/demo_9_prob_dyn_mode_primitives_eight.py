...
def demo(variables=None):
    """
    This demo shows an example of the probabilistic dynamic mode primitives on a eight shape dataset
    :return: None
    """
    ...
    data = EightShapes(t_steps, s_size=args.samples, prng_handler=prng_handler)
