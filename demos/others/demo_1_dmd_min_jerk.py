...
from data import MinimumJerk
from models.dmd_models import *
from utils.utils_general import data2snapshots
from utils.prng_handler import PRNGHandler
from utils.utils_kernels import *
...
parser.add_argument("--trunc_svd", default=0.999, type=int,
...
def demo():
    ...
    ax.plot(t_steps, data.transform[0].T, alpha=0.3, label="Data", linewidth=2.5)
    ax.legend()
